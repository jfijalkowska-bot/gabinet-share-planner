  ...
  try {
    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: "system", content: "Jesteś doświadczonym psychoterapeutą-superwizorem. Pomagasz terapeutom w analizie sesji terapeutycznych. Odpowiadasz po polsku, profesjonalnie i empatycznie." },
          ...messages,
        ],
      }),
    });
